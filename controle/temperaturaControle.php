...
class PDF extends FPDF{
    function Header(){
        ...
        $this->Cell(0, 0.5, "Relatorio Temperatura", 0,1, 'C');
...
$fpdf->Cell(5,1, "Temperatura", 1,0,'C');
$fpdf->Cell(5,1, "Hora Monitoramento", 1,0,'C');
$fpdf->Cell(5,1, "Data Monitoramento", 1,1,'C');
 ...
 $connDB  = conexaoPDO::getConnection();
    ...
    public function __construct() {
            ...
            while($row = $resultsquery->fetch()){
                ...
                $fpdf->Cell(5, 1, $row->temperatura, 1, 0, 'C');
                $fpdf->Cell(5, 1, $row->hora, 1, 0, 'C');
                $fpdf->Cell(5, 1, $row->data_monitoramento, 1, 1, 'C');
